      ...
      <div className='container mx-auto'>
        <div className='flex flex-col md:flex-row md:justify-between justify-center items-center text-center'>
          <h3
            data-aos-offset='400'
            data-aos='fade-right'
            className='text-2xl md:mb-4 mb-8 font-semibold'>
            Awesome experience with VR
          </h3>
          ...
          <div
            ...
            className='bg-videoBg bg-no-repeat bg-cover w-[270px] h-[180px] flex items-center justify-center group cursor-pointer'>
            <div>
