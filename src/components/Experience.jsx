      ...
      <div className='container mx-auto'>
        <div
          ...
          <div
            data-aos='fade-left'
            data-aos-offset='400'
            className='mt-6 flex-1 flex flex-col items-start justify-center md:mt-0'>
            <h2 className='text-3xl font-bold mb-6'>
              New Experience In Playing Games
            </h2>
            <p className='font-secondary mb-6'>
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Exercitationem nobis eaque blanditiis dolorem ducimus. Quas illum,
              rem suscipit error libero id tempora earum fugiat neque maiores
              fugit quod, hic facere.
            </p>
